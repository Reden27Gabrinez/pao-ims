    ...
    <!-- AdminLTE App -->
    <script src="admin/plugins/dist/js/adminlte.min.js"></script>
...
<!-- Manage Personnel-->
    ...
    <script src="admin/pugins/dist/js/demo.js"></script>
    <!-- Page specific script -->
<!-- Manage Personnel-->
<!-- profile -->
    <script src="admin/plugins/time.js"></script>
    <!-- sweetalert for confirmation -->
    <script src="admin/plugins/sweetalert.min.js"></script>
<!-- profile -->

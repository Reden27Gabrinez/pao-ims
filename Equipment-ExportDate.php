...
$user   = $_SESSION['id'];
$query  = $conn->query("SELECT * FROM fem WHERE user='$user' && date(created_at) between '$fdate' and '$tdate' ORDER BY created_at DESC"); 
 
if($query->num_rows > 0){ 
    $delimiter = ","; 
    $filename = "Equipments-data_" . $fdate  ." to " .$tdate. ".csv"; 

        ...
        <div class="container">
          ...
          <div class="card mt-5">
            <div class="card-header">
              <h3 class="card-title">Baliangao Machinery</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <?php
                    $query  = "SELECT * FROM fem WHERE municipality = 'Baliangao' AND categories = 'Equipment' AND categories = 'Facility' AND categories = 'Machinery' ORDER BY created_at DESC";

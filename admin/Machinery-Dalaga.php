        ...
        <div class="container">
          ...
          <div class="card mt-5">
            <div class="card-header">
              <h3 class="card-title">Sapang Dalaga Machinery</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <?php
                    $query  = "SELECT * FROM fem WHERE municipality = 'Sapang Dalaga' AND categories = 'Machinery' ORDER BY created_at DESC";
